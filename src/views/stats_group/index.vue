<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-top: 7px;">
      ...
      <a href="#/stats" class="link-type" style="float: right; margin-top: 10px;" icon="el-icon-upload">События списком</a>

    </div>

    <table border="1">
      <tr>
        <td>Ключевые показатели результативности</td>
        <td>
          <table border="1">
            <tr><td>Администрация ВАСИЛЕОСТРОВСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
                <tr><td>Просмотр объекта</td></tr>
                <tr><td>Изменение объекта</td></tr>
                <tr><td>Формирование печатной формы</td></tr>
                <tr><td>Формирование отчета</td></tr>
                <tr><td>Создание объекта</td></tr>
                <tr><td>Экспорт данных</td></tr>
                <tr><td>Импорт данных</td></tr>
                <tr><td>Удаление объекта</td></tr>
                <tr><td>Вызов внешнего сервиса</td></tr>
                <tr><td>Продление сессии пользователя</td></tr>
                <tr><td>Завершение сессии пользователя</td></tr>
              </table>
            </td></tr>
            <tr><td>Администрация ВЫБОРГСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КАЛИНИНСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КИРОВСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КОЛПИНСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КРАСНОГВАРДЕЙСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КРАСНОСЕЛЬСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КРОНШТАДТСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация КУРОРТНЫЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация МОСКОВСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация НЕВСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ПЕТРОГРАДСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ПЕТРОДВОРЦОВЫЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ПРИМОРСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ПУШКИНСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ФРУНЗЕНСКИЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
            ...
            <tr><td>Администрация ЦЕНТРАЛЬНЫЙ район</td>    <td>
              <table border="1">
                <tr><td>Аутентификация пользователя</td></tr>
                <tr><td>Вход в систему (визит)</td></tr>
                <tr><td>Обращение к справочнику</td></tr>
